...
public class RxFirestoreTest {
    ...
    public void setup() {
        ...
        RxTestUtil.setupTask(documentSnapshotTask);
        RxTestUtil.setupTask(emptyDocumentSnapshotTask);
        RxTestUtil.setupTask(queryResultTask);
        RxTestUtil.setupTask(emptyQueryResultTask);
        RxTestUtil.setupTask(mockVoidTask);
        RxTestUtil.setupOfflineTask(documentReference, registration);
    ...
    public void testGetDocument() {
        ...
        RxTestUtil.testOnSuccessListener.getValue().onSuccess(documentSnapshot);
    ...
    public void testGetEmptyDocument() {
        ...
        RxTestUtil.testOnSuccessListener.getValue().onSuccess(emptyDocumentSnapshot);
    ...
    public void testGetCollection() {
        ...
        RxTestUtil.testOnSuccessListener.getValue().onSuccess(querySnapshot);
    ...
    public void testGetEmptyCollection() {
        ...
        RxTestUtil.testOnSuccessListener.getValue().onSuccess(emptyQuerySnapshot);
    ...
    public void testSetDocumentOffline() {
        ...
        RxTestUtil.eventSnapshotListener.getValue().onEvent(documentSnapshot, null);
